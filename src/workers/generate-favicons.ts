...
export const generate_favicons = async (avatar_url: string) => {
    ...
    promises.push(
        ...
        .resize(512, 512)
        .png()
        .toFile(`${__dirname}/../assets/server/android-chrome-512x512.png`)
    );
    promises.push(
        sharp(android_icon)
        .resize(192, 192)
        .png()
        .toFile(`${__dirname}/../assets/server/android-chrome-192x192.png`)
    );
    ...
    promises.push(
        ...
        .resize(180, 180)
        .png()
        .toFile(`${__dirname}/../assets/server/apple-touch-icon.png`)
    );
    ...
    promises.push(
        ...
        .resize(32, 32)
        .png()
        .toFile(`${__dirname}/../assets/server/favicon-32x32.png`)
    );
    promises.push(
        sharp(avatar)
        .resize(16, 16)
        .png()
        .toFile(`${__dirname}/../assets/server/favicon-16x16.png`)
    );
    ...
    promises.push(fs.promises.writeFile(`${__dirname}/../assets/server/favicon.ico`, favicon_buffer));
